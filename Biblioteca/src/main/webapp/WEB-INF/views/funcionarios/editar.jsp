                ...
                <form action="funcionarios?action=atualizar" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <label for="nome">Nome:</label> <input type="text" id="nome" name="nome"
                            value="${funcionarios.nome}" required>
                    </div>
                    <div class="form-cpf">
                        <div>
                        ...
                        <div>
                            <label for="nascimento">Data de Nascimento:</label><br> <input type="date"
                                value="${funcionarios.nascimento}" id="nascimento" name="nascimento" required>
                        </div>
                    </div>
                    <div class="form-cep">
                        <div>
                            <label>Cep: <input name="cep" type="text" id="cep" value="${funcionarios.cep}" size="10"
                                    maxlength="9" onblur="pesquisacep(this.value);" /></label><br />
                        </div>
                        <div>
                            <label>Rua: </label><input name="rua" type="text" value="${funcionarios.rua}" id="rua"
                                size="60" /><br />
                        </div>
                        <div>
                            <label for="numero">Número:</label> <input type="text" value="${funcionarios.numero}"
                    ...
                    <div class="form-cep">
                        ...
                        <div>
                            <label>Estado:</label>
                            <input name="uf" type="text" id="uf" size="2" value="${funcionarios.estado}"
                                maxlength="2"><br />
                        </div>
                    </div>
                    <div class="form-cep">
                        ...
                        <div>
                            <label for="admissao">Admissão:</label> <input type="date" id="admissao" name="admissao"
                                value="${funcionarios.admissao}" required>
                        </div>
                        <div>
                            <label for="password">Senha:</label><br>
                            
                            <c:if test="${funcionarios.id_funcionario ne sessionScope.id_func}">
						    	<input type="hidden" id="password" name="password" value="${funcionarios.senha}">
							</c:if>
