                ...
                <table border="1">
                    ...
                    <c:forEach items="${lista}" var="funcionarios">
                        <tr>
                            ...
                            <td>
                                <a href="funcionarios?action=editar&id_funcionario=${funcionarios.id_funcionario}">Editar</a>
                             <c:if test="${sessionScope.funcao eq Gerente}">
                                <a href="funcionarios?action=deletar&id_funcionario=${funcionarios.id_funcionario}">Excluir</a>
                            </c:if>
                            </td>
                        </tr>
                    </c:forEach>
