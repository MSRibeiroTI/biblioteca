            ...
            <form action="cliente?action=atualizar_cliente" method="post"
                ...
                <div class="form-cep">
                    <div>
                   	...
                   	<div>
                    	<label>Rua: </label><input name="rua" type="text" value="${cliente.rua}" id="rua" size="60" /><br />
	                 </div>
	                 <div>
                ...
                <div class="form-cep">
                   <div>
	                    ...
	                    <input type="text" id="bairro" value="${cliente.bairro}" name="bairro" required>
                   </div>
	                <div>
                   ...
                   <div>
	                    <label>Estado:</label>
	                    <input name="uf" type="text" id="uf" size="2" value="${cliente.estado}" maxlength="2"><br />
                	</div>
                </div>
                <div class="form-group">
                    <label for="referencias">Referências:</label>
                    <textarea id="referencias" name="referencias" required>${cliente.referencias}</textarea>
                </div>
                <div class="btn-index">
